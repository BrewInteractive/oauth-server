...
class JwtServiceTest {
    ...
    @ParameterizedTest
    @MethodSource
    void should_sign_token(String subject, String audience, String issuerUri, String state, Integer tokenExpiresInMinutes, String signingKey, HashMap<String, Object> additionalClaims) {
