...
public interface RefreshTokenService {
    ...
    RefreshToken revokeRefreshToken(String clientId, Long userId, String token, int expirationTimeInDays, String newToken) throws RefreshTokenNotFoundException;
}